...
public class NewClassLoaderInjector {
    ...
    public static ClassLoader inject(Application app, ClassLoader oldClassLoader,List<File> patches) throws Throwable {
    ...
    private static ClassLoader createNewClassLoader(Context context, ClassLoader oldClassLoader,
                                                    ClassLoader dispatchClassLoader,List<File> patches) throws Throwable {
        //得到pathList
